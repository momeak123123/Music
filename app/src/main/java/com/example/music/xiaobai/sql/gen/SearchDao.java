...
public class SearchDao extends AbstractDao<Search, Long> {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_SEARCH__id ON \"SEARCH\"" +
                " (\"_id\" ASC);");
    }
    ...
    public Search readEntity(Cursor cursor, int offset) {
        Search entity = new Search( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // txt
    ...
    public void readEntity(Cursor cursor, Search entity, int offset) {
        ...
        entity.setTxt(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
